...
var textObserver = getIntObserver({ threshold: 0.15, rootMargin: '-15%' });
document
    .querySelectorAll('.anim-text')
    .forEach(function (el) { return textObserver.observe(el); });
document.addEventListener('DOMContentLoaded', function () {
    document
        .querySelectorAll('.anim-onload')
        .forEach(function (el) { return el.classList.add('animate'); });
}, false);
var sectionObserver = getIntObserver({ threshold: 0.2 });
document
    .querySelectorAll('.anim-section')
    .forEach(function (el) { return sectionObserver.observe(el); });
document
    .querySelectorAll('.anim-parent')
    .forEach(function (el) { return sectionObserver.observe(el); });
...
var bgObserver = new IntersectionObserver(function (entries, obs) {
    entries.forEach(function (_a) {
        var target = _a.target, isIntersecting = _a.isIntersecting;
        if (isIntersecting) {
            var bgElement = target;
            bgElement.classList.add('original_bg');
            obs.unobserve(target);
        }
    });
}, options);
document
    .querySelectorAll('.lazy_loading_bg')
    .forEach(function (el) { return bgObserver.observe(el); });
...
;// CONCATENATED MODULE: ./src/scripts/datepicker.ts


var isMobile = document.body.clientWidth < 960;
new index_es('#static-form-datepicker', {
    isMobile: isMobile,
    autoClose: true
});
new index_es('#dialog-form-datepicker', {
    isMobile: isMobile,
    autoClose: true
});

// EXTERNAL MODULE: ./src/scripts/animation.ts
var animation = __webpack_require__(131);
;// CONCATENATED MODULE: ./src/scripts/utils.ts
function getOutsideClickHandler(el, cb) {
    return function (_a) {
        var target = _a.target;
        if (el && target.contains(el) && target !== el) {
            cb();
        }
    };
}
function getEscapeHandler(cb) {
    return function (e) {
        if (e.code === 'Escape') {
            cb();
        }
...
;// CONCATENATED MODULE: ./src/scripts/form.ts

var dialogForm = document.getElementById('dialog-form');
var closeFormBtn = document.getElementById('close-form-btn');
var form_isMobile = document.body.clientWidth < 960;
var outsideClose = getOutsideClickHandler(dialogForm, closeForm);
var keyClose = getEscapeHandler(closeForm);
function closeForm() {
    dialogForm === null || dialogForm === void 0 ? void 0 : dialogForm.classList.remove('opened');
    document.removeEventListener('keydown', keyClose);
    closeFormBtn === null || closeFormBtn === void 0 ? void 0 : closeFormBtn.removeEventListener('click', closeForm);
    if (!form_isMobile) {
        document.removeEventListener('click', outsideClose);
    }
}
function openForm() {
    dialogForm === null || dialogForm === void 0 ? void 0 : dialogForm.classList.add('opened');
    document.addEventListener('keydown', keyClose);
    closeFormBtn === null || closeFormBtn === void 0 ? void 0 : closeFormBtn.addEventListener('click', closeForm);
    if (!form_isMobile) {
        document.addEventListener('click', outsideClose);
    }
}
document
    .querySelectorAll('.open-form-btn')
    .forEach(function (el) { return el.addEventListener('click', openForm); });
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.form').forEach(function (form) {
        form.addEventListener('submit', function (event) {
            ...
            document.querySelectorAll('button').forEach(function (el) { return (el.disabled = true); });
            xhr.onload = function () {
                if (xhr.status === 200) {
                    closeForm();
                    document.querySelectorAll('input').forEach(function (el) { return (el.value = ''); });
                    var snackbar_1 = document.getElementById('success-send-form');
                    snackbar_1.style.bottom = '50px';
                    setTimeout(function () { return (snackbar_1.style.bottom = '-100px'); }, 2000);
                }
                else {
                ...
                document
                    ...
                    .forEach(function (el) { return (el.disabled = false); });
            };
...
;
;// CONCATENATED MODULE: ./src/assets/png/section-5_1.png
const section_5_1_namespaceObject = __webpack_require__.p + "0e50695eb2278b3ac088.png";
;// CONCATENATED MODULE: ./src/assets/png/section-5_3.png
const section_5_3_namespaceObject = __webpack_require__.p + "8c090b96ec570378721e.png";
;// CONCATENATED MODULE: ./src/assets/png/section-5_4.png
const section_5_4_namespaceObject = __webpack_require__.p + "9fd8780fae7bcbe89f64.png";
;// CONCATENATED MODULE: ./src/assets/png/section-5_5.png
const section_5_5_namespaceObject = __webpack_require__.p + "88cf5a162320e2043840.png";
;// CONCATENATED MODULE: ./src/assets/png/section-5_6.png
const section_5_6_namespaceObject = __webpack_require__.p + "831d2ebda2cdaa804292.png";
;// CONCATENATED MODULE: ./src/assets/png/section-5_7.png
const section_5_7_namespaceObject = __webpack_require__.p + "5bcc4c0068545ec84f1e.png";
;// CONCATENATED MODULE: ./src/scripts/light-box.ts
...
function openLightBox() {
    ...
    iframe.src = 'https://player.vimeo.com/video/800907168?h=2dc7b2a28e&autoplay=1&title=0&byline=0&portrait=0';
    iframe.allow = 'autoplay; fullscreen; picture-in-picture';
    iframe.allowFullscreen = true;
    if (this.classList.contains('row_1-col_1')) {
        img.src = section_5_1_namespaceObject;
        lightBox.appendChild(img);
        document.body.appendChild(lightBox);
    }
    else if (this.classList.contains('row_1_2-col_2')) {
        lightBox.appendChild(iframe);
        document.body.appendChild(lightBox);
    }
    else if (this.classList.contains('row_1-col_4')) {
        img.src = section_5_3_namespaceObject;
        lightBox.appendChild(img);
        document.body.appendChild(lightBox);
    }
    else if (this.classList.contains('row_2-col_3_4')) {
        img.src = section_5_4_namespaceObject;
        lightBox.appendChild(img);
        document.body.appendChild(lightBox);
    }
    else if (this.classList.contains('row_1-col_5')) {
        img.src = section_5_5_namespaceObject;
        lightBox.appendChild(img);
        document.body.appendChild(lightBox);
    }
    else if (this.classList.contains('row_1_2-col_6')) {
        img.src = section_5_6_namespaceObject;
        lightBox.appendChild(img);
        document.body.appendChild(lightBox);
    }
    else if (this.classList.contains('row_2-col_7')) {
        img.src = section_5_7_namespaceObject;
        lightBox.appendChild(img);
        document.body.appendChild(lightBox);
    }
    else if (this.classList.contains('overlay-btn')) {
        lightBox.appendChild(iframe);
        document.body.appendChild(lightBox);
    }
    else if (this.classList.contains('showreel')) {
        lightBox.appendChild(iframe);
        document.body.appendChild(lightBox);
    }
}
document
    .querySelectorAll('.with-lightbox')
    .forEach(function (el) {
    el.addEventListener('click', openLightBox);
});

// EXTERNAL MODULE: ./src/scripts/lazy-loading.ts
var lazy_loading = __webpack_require__(533);
